...
export const Wallet: FC<closeWallet> = ({ onClose }) => {
    ...
    return (
        <div className="wallet">
            <div className="wallet__headline">
                Connecting wallet
                <IcSharpClose1 className="wallet__btn--close" onClick={handleClose} />
            </div>
            <div className="inner__inner">
                {!isSvgVisible && (
                    <div className="wallet__inner">
                        <div className="wallet__inner--info">
                            <div className="inner__info--video">
                                <div className="inner__info--number">1.</div>
                                <div className="info__video--circle">
                                    <svg
                                        className="play"
                                        width="9.000000"
                                        height="10.392578"
                                        viewBox="0 0 9 10.3926"
                                        fill="none"
                            ...
                            <div className="inner__info--desc">Описание что нужно сделать</div>
                        </div>
                        <div className="wallet__inner--info">
                            <div className="inner__info--video">
                                <div className="inner__info--number">2.</div>
                                <div className="info__video--circle">
                                    <svg
                                        className="play"
                                        width="9.000000"
                        ...
                        <div className="wallet__inner--info">
                            <div className="inner__info--video">
                                <div className="inner__info--number">3.</div>
                                <div className="info__video--circle">
                                    <svg
                                        className="play"
                                        width="9.000000"
                ...
                {isBtnVisible && (
                    <button className="wallet__inner--btn" onClick={handleConnectWallet}>
                        Connect wallet
                    </button>
                )}
                {isSvgVisible && (
                    <div className="meta">
                        <div className="meta__circle">
                        ...
                        <span className="install">Initializing</span>
                    </div>
                )}
            </div>
        </div>
